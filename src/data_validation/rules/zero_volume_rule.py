"""
regra responsável por detectar volume zero.
"""
...
class ZeroVolumeRule(BaseMaskValidationRule):
    """detecta volumes iguais a zero."""

    @property
    def name(self) -> str:
        return "Zero Volume Rule"
    ...
    @property
    def config(self):
        return settings.validation.zero_volume
