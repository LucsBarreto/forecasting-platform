...
@pytest.fixture
def model() -> CatBoostModel:
    """Return a deterministic CatBoost model."""
...
def test_random_seed_makes_predictions_reproducible(
    training_data: tuple[pd.DataFrame, pd.Series],
) -> None:
    """Same random seed must produce reproducible predictions."""
